...
function HeroSection() {
  ...
  <div className='absolute inset-0 bg-[url("/backgroundImage.png")] bg-cover bg-center bg-no-repeat z-0' />
  
  <div className='relative z-10'>
    <img src={assets.marvelLogo} alt="logo" className='max-h-11 lg:h-11 mt-20'/>
    <h1 className='text-5xl md:text-[70px] md:leading-[1.2] font-semibold max-w-110 text-white'>
